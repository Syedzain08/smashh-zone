...
export const metadata: Metadata = {
  ...
  description:
    'Full schedule and match categories for the Smashh Zone Badminton Championship — U17, U19, and Open — Sep 19–20, 2026 at Gaddafi Stadium, Lahore.',
};
...
const CATEGORIES: Category[] = [
  {
    code: 'U17',
    name: 'Under-17',
    eligibility: 'Ages 15 to 16 (Under 17 as of Sep 19, 2026)',
  ...
  },
  {
    code: 'U19',
    name: 'Under-19',
    eligibility: 'Ages 15 to 18 (Under 19 as of Sep 19, 2026)',
    format: 'Singles, Doubles & Mixed',
    day: 'Day 01 · Sep 19',
    window: 'Starts 10:00 AM',
    note: 'Original CNIC or B-Form required at check-in for age verification',
